# Upstream-`.deb` handoff candidates (generated 5 Sep 2026 · marked 6 Sep)
...
| Tool | Upstream | Latest tag | `.deb`s in release | Status |
|---|---|---|---|---|
| bat | sharkdp/bat | v0.26.1 | 8 | **Marked for handoff** — no action |
| bottom | ClementTsang/bottom | 0.14.9 | 6 | **Marked for handoff** — no action |
| du-dust | bootandy/dust | v1.2.5 | 2 | **Marked for handoff** — no action |
| fastfetch | fastfetch-cli/fastfetch | 2.68.1 | 10 | **Marked for handoff** — no action |
| fd | sharkdp/fd | v10.5.0 | 8 | **Marked for handoff** — no action |
| fzf | junegunn/fzf | v0.74.3 | 9 | **Marked for handoff** — no action |
| git-delta | dandavison/delta | 0.19.2 | 5 | **Marked for handoff** — no action |
| gum | charmbracelet/gum | v2.0.0 | 5 | **Marked for handoff** — no action |
| helix | helix-editor/helix | 25.07.1 | 1 | **Marked for handoff** — no action |
| hexyl | sharkdp/hexyl | v0.17.0 | 7 | **Marked for handoff** — no action |
| hyperfine | sharkdp/hyperfine | v1.20.0 | 7 | **Marked for handoff** — no action |
| k9s | derailed/k9s | v0.51.0 | 5 | **Marked for handoff** — no action |
| ripgrep | BurntSushi/ripgrep | 15.2.0 | 1 | **Marked for handoff** — no action |
| watchexec | watchexec/watchexec | v2.7.1 | 9 | **Marked for handoff** — no action |
| zoxide | ajeetdsouza/zoxide | v0.10.0 | 5 | **Marked for handoff** — no action |

**Decision of 5 Sep 2026 (maintainer): all 15 are marked for handoff —
flagged, not actioned.** No entry graduates until upstream runs a real
apt index. The packages keep building and shipping in the meantime.

**Redirections at handoff time will be handled by
[`ranjithrajv/lpt`](https://github.com/ranjithrajv/lpt)** — a
multi-arch Debian package builder CLI, planned to carry the redirect
logic so each handoff lands users on the right upstream channel
automatically. Until lpt ships, handoffs stay flagged and unpublished.
...
## Process for each handoff (when it's approved AND lpt is live)
...
3. Archive or mark the tool's `*-debian` repo; keep its releases for
   provenance.
4. Redirect users via [`ranjithrajv/lpt`](https://github.com/ranjithrajv/lpt)
   (once launched) so installs of the retired package resolve to the
   upstream channel; the coverage table, staleness report, and status page
   pick up the removal automatically.
